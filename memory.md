...
> 阶段状态：**准备发布 `1.7.3-KMP-B`。** 教学周/作业容错 + KMP GitHub Actions 打包。不用 `1.7.3-B`（字典序会比 `1.7.3-KMP-A` 更旧）。
> 分支创建点：`9d8da18`；上游对照基线：`v1.7.0@419313d`；KMP 自身基线即将变为 **`v1.7.3-KMP-B`**；上一发布 `v1.7.3-KMP-A@6c69c85` 保留。
